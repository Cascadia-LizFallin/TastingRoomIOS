...
class NoseTableViewController: UITableViewController {

    // Characteristics for Nose
    var listData = ["Condition", "Intensity", "Aroma Characteristics"]
